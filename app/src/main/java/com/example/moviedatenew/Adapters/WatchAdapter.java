...
public class WatchAdapter extends RecyclerView.Adapter<WatchAdapter.MyViewHolder> {
    ...
    Context context;
    List<Watch_list> mdata;
    WatchItemClickListner jewelleryItemClickListener;


    public WatchAdapter(Context context, List<Watch_list> mdata, WatchItemClickListner listener) {
    ...
    @NonNull
    @Override
    public WatchAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View view= LayoutInflater.from(context).inflate(R.layout.item_jewellery,viewGroup,false);
        return new WatchAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull WatchAdapter.MyViewHolder myViewHolder, int i) {
        ...
        public MyViewHolder(@NonNull View itemView) {             //add for MD
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    jewelleryItemClickListener.onWatchClick(mdata.get(getAdapterPosition()),ImgJewellery);
                }
            });
